-- ========================================
-- SCRIPT COMPLET : NETTOYAGE + RÉINSERTION TOTALE
-- Supprime TOUS les tutoriels et réinsère une collection complète
-- ========================================
...
-- Supprimer TOUS les tutoriels blog existants
DELETE FROM blog_posts;

-- Vérification : Le compteur doit afficher "DELETE X" où X est le nombre supprimé
-- SELECT COUNT(*) FROM blog_posts; -- Devrait retourner 0

-- ========================================
-- ÉTAPE 2 : INSERTION DE TOUS LES TUTORIELS
-- 8 tutoriels au total : 4 Cloud + 4 Docker/DevOps
-- ========================================
...
-- Afficher tous les tutoriels insérés
SELECT
    title,
    slug,
    category,
...
DO $$
BEGIN
    RAISE NOTICE '✅ SUCCÈS : 8 tutoriels insérés (4 Cloud + 4 DevOps/Docker)';
